...
import com.quartz.sumit.examples.example2.SimpleJob;
...
/**
 * This example will demonstrate how calendars can be used to exclude periods of time when
 * scheduling should not take place.
 */
public class CalendarExample {
  ...
  public void run() throws Exception {
    ...
    Calendar independenceDay = new GregorianCalendar(2024, Calendar.AUGUST, 15);
    Calendar republicDay = new GregorianCalendar(2024, Calendar.JANUARY, 26);
    Calendar diwali = new GregorianCalendar(2024, Calendar.OCTOBER, 27);

    holidays.setDayExcluded(independenceDay,true);
    holidays.setDayExcluded(republicDay, true);
    holidays.setDayExcluded(diwali, true);
